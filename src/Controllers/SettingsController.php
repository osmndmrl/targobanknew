...
use TARGOBANK\Services\NotificationService;
...
class SettingsController extends Controller
{
    ...
    {
        if($request->get('TARGOBANKMode') == 'targobank' || $request->get('TARGOBANKMode') == 'targobank_installment')
        {
            return $this->settingsService->saveSettings($request->get('TARGOBANKMode'), $request->get('settings'));
        }
    }
