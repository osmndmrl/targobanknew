...
namespace TARGOBANK\Constants;

/**
 * Class NotificationEvents
 * @package TARGOBANK\Constants
 */
class NotificationEvents
{
    ...
    const PAYMENT_CAPTURE_REVERSED = 'PAYMENT.CAPTURE.REVERSED';	// TARGOBANK reverses a payment capture.
    ...
    const PAYMENT_SALE_REVERSED = 'PAYMENT.SALE.REVERSED';	    // TARGOBANK reverses a sale.
