...
class TARGOBANKInstallmentSpecificPromotion
{
    /**
     * @param Twig $twig
                            ...
                            $arg)
    {
        ...
        if($amount > 0)
        {
            ...
            $paymentService->loadCurrentSettings('targobank_installment');
        ...
        return $twig->render('TARGOBANK::TARGOBANKInstallment.SpecificPromotion', ['amount'=>$amount, 'financingOptions'=>$qualifyingFinancingOptions, 'item'=>$item, 'id'=>$id]);
    }
