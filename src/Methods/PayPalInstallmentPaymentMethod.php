...
class TARGOBANKInstallmentPaymentMethod extends PaymentMethodService
{
    /**
    ...
    /**
     * TARGOBANKPlusPaymentMethod constructor.
     *
                                 ...
                                 PaymentService              $paymentService)
    {
        ...
        $this->paymentService->loadCurrentSettings('targobank_installment');
    }
