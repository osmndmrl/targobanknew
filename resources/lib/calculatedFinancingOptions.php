...
if($sandbox)
{
    $url = 'https://api.sandbox.targobank.com/v1/oauth2/token';
}
else
{
    $url = 'https://api.targobank.com/v1/oauth2/token';
}
...
if(isset($authResult['access_token']))
{
    ...
    if($sandbox)
    {
        $url = 'https://api.sandbox.targobank.com/v1/credit/calculated-financing-options';
    }
    else
    {
        $url = 'https://api.targobank.com/v1/credit/calculated-financing-options';
    }
